        ...
        <View style={styles.card}>
            ...
            <View style={styles.counterContainer}>
                <View style={styles.counter}>
                    ...
                    <Text style={styles.connterLabel} >DAYS</Text>
                </View>
                <View style={styles.counter}>
                    <Text style={styles.counterText} >{hours}</Text>
                    <Text style={styles.connterLabel} >HOURS</Text>
                </View>
                <View style={styles.counter}>
                    <Text style={styles.counterText} >{minutes}</Text>
                    <Text style={styles.connterLabel} >MINUTES</Text>
                </View>
                <View style={styles.counter}>
                    <Text style={styles.counterText} >{seconds}</Text>
                    <Text style={styles.connterLabel} >SECONDS</Text>
                </View>
            </View>
        </View>
    )
